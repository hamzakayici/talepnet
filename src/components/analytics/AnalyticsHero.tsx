        ...
        <div className="mb-[72px] flex flex-col items-center justify-center">
          <div className="mx-auto w-[95%] max-w-[850px] space-y-4 text-center">
            <RevealAnimation delay={0.3}>
              <h2>
                İşiniz. Metrikleriniz. <br className="hidden md:block" />
                Hepsi tek bir ekranda.
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p>
                TalepNET ile neyin işe yaradığını anlamak için düzinelerce araca ihtiyacınız yok. Sezgisel kontrol panelimiz
                temel metriklerinizi merkezileştirerek performansı izlemenize, trendleri fark etmenize ve daha akıllı, daha hızlı
                kararlar almanıza yardımcı olur.
              </p>
            </RevealAnimation>
          </div>
        </div>
