...
export default function ProductManagementPage({
  ...
  const heroBg =
    theme === 'teal'
      ? 'bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.16),transparent_30%),radial-gradient(circle_at_top_right,rgba(59,130,246,0.12),transparent_28%),linear-gradient(180deg,#f4fcf8_0%,#ffffff_52%,#f8fafc_100%)]'
      : 'bg-[radial-gradient(circle_at_top_left,rgba(34,197,94,0.12),transparent_30%),radial-gradient(circle_at_top_right,rgba(59,130,246,0.12),transparent_28%),linear-gradient(180deg,#f6fbf7_0%,#ffffff_52%,#f8fafc_100%)]';
          ...
          <RevealAnimation delay={0.22}>
            <div className="overflow-hidden rounded-[28px] border border-stroke-3 bg-white dark:border-stroke-7 dark:bg-background-6">
              <div className="grid gap-0 lg:grid-cols-[0.95fr_1.05fr]">
                ...
                <ImagePlaceholder label={page.sections.corePointsPlaceholder} className="min-h-[280px] lg:min-h-full" />
              </div>
            </div>
          </RevealAnimation>
        </div>
        ...
        <section className="bg-background-12 py-20 dark:bg-background-5 md:py-24 xl:py-32">
          <div className="main-container grid gap-8 lg:grid-cols-[0.94fr_1.06fr]">
            <RevealAnimation delay={0.12}>
              <div className="overflow-hidden rounded-[28px] border border-stroke-3 bg-white dark:border-stroke-7 dark:bg-background-6">
                <ImagePlaceholder label={page.sections.middlePlaceholder || ''} className="min-h-[280px] sm:min-h-[360px]" />
              </div>
            </RevealAnimation>
            <RevealAnimation delay={0.18}>
              <div className="space-y-5">
                <span className="hero-badge text-tagline-1 inline-block text-secondary dark:text-accent">
                  {page.sections.middleEyebrow}
                </span>
                <h2 className="text-4xl font-normal leading-tight text-secondary dark:text-accent lg:text-heading-3">
                  {page.sections.middleTitle}
                </h2>
                <p className="text-base leading-7 text-secondary/72 dark:text-accent/70">
                  {page.sections.middleText}
                </p>
              </div>
            </RevealAnimation>
          </div>
      ...
      <section className="bg-white py-20 dark:bg-background-6 md:py-24 xl:py-32">
        <div className="main-container grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <RevealAnimation delay={0.18}>
            <div className="rounded-[28px] border border-stroke-3 bg-white p-8 dark:border-stroke-7 dark:bg-background-6 lg:p-10">
              <span className="hero-badge text-tagline-1 inline-block text-secondary dark:text-accent">
                {page.sections.insightsListEyebrow}
              </span>
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                {page.insightBlocks.map((item) => (
                  <div
                    key={item}
      ...
      <section className="bg-background-12 py-20 dark:bg-background-5 md:py-24 xl:py-32">
        <div className="main-container grid gap-10 lg:grid-cols-[0.78fr_1.22fr]">
          ...
          <RevealAnimation delay={0.24}>
            <Accordion className="space-y-4" defaultValue="management-faq-1" animationDelay={0.08}>
              {page.faqs.map((faq, index) => (
                <AccordionItem
                  key={faq.question}
                  value={`management-faq-${index + 1}`}
