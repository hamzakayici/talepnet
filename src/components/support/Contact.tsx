          ...
          <div className="col-span-12 lg:col-span-6">
            <div className="mb-[70px] space-y-5 text-left">
              <RevealAnimation delay={0.1}>
                <span className="badge badge-green">Destek</span>
              </RevealAnimation>
              <div className="space-y-3">
                ...
                <RevealAnimation delay={0.3}>
                  <p className="max-w-[550px]">
                    Sorunuz, geri bildiriminiz veya özellik isteğiniz mi var? Sizden duymakı çok isteriz! Lütfen
                    aşağıdaki formu doldurun, destek ekibimiz en kısa sürede size dönecektir.
                  </p>
                </RevealAnimation>
              </div>
            </div>
