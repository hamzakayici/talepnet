    ...
    >
      <div className="main-container relative">
        <RevealAnimation delay={0.1}>
          ...
          >
            TalepNET, kullanıcıların önde gelen şirketlerde iş bulmalarına yardımcı olmuştur.
          </h2>
        </RevealAnimation>
        <RevealAnimation delay={0.2} instant>
          <div
            className="mt-14 overflow-hidden"
            aria-label="Logos of companies where TalepNET users have found employment"
          >
