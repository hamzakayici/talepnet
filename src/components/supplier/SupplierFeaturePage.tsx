...
import { ArrowRight, Check, LucideIcon, Send } from 'lucide-react';
...
export default function SupplierFeaturePage({ page, flowId, placeholderLabel, featureIcons }: Props) {
  ...
  return (
    <main className="overflow-x-hidden bg-white dark:bg-background-6">
            ...
            <RevealAnimation delay={0.35} direction="right">
              <div className="grid gap-4">
                <div className="overflow-hidden rounded-[28px] border border-stroke-3 bg-white shadow-[0_30px_80px_rgba(15,23,42,0.08)] dark:border-stroke-7 dark:bg-background-5">
                  <ImagePlaceholder label={placeholderLabel} className="min-h-[320px] sm:min-h-[390px]" />
                </div>
      ...
      <section id={flowId} className="bg-background-12 py-20 dark:bg-background-5 md:py-24 xl:py-28">
      ...
      <section className="border-t border-stroke-3 bg-background-12 py-20 dark:border-stroke-7 dark:bg-background-5 md:py-24 xl:py-28">
        <div className="main-container grid gap-10 lg:grid-cols-[0.74fr_1.26fr]">
          ...
          <div className="space-y-4">
            <Accordion className="space-y-4" defaultValue="supplier-feature-faq-1" animationDelay={0.08}>
              {page.faqs.map((item, index) => (
                <AccordionItem
                  key={item.question}
                  value={`supplier-feature-faq-${index + 1}`}
              ...
              <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
                ...
                <div className="flex flex-wrap gap-3 lg:justify-end">
                  ...
                  <LinkButton
                    ...
                    className="btn btn-white btn-md hover:btn-accent">
