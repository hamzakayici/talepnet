      ...
      <div className="main-container">
        <div className="text-center">
          <RevealAnimation delay={0.1}>
            <span className="badge badge-green-v2 mb-5"> Basın </span>
          </RevealAnimation>
          <div className="mt-5 mb-14 space-y-4 text-center">
            <RevealAnimation delay={0.2}>
              <h1 className="font-normal">
                TalepNET'ten en <span className="text-primary-500">güncel</span> <br />
                haberler ve duyurular
              </h1>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p>
                Resmi basın bültenleri, ürün duyuruları
                <br />
                ve medya haberleri tek bir yerde.
              </p>
            </RevealAnimation>
          </div>
