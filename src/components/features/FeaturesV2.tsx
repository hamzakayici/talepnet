    ...
    <section className="pt-32 pb-28 sm:pt-36 md:pt-42 xl:pt-[200px]">
      <div className="main-container flex flex-col-reverse items-center gap-x-24 gap-y-12 overflow-hidden lg:flex-row">
        ...
        <div className="flex flex-col md:flex-1 lg:items-start lg:text-left">
          <RevealAnimation delay={0.2}>
            <h2 className="mb-3">Somut sonuçlar sunmak için tasarlandı</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.3}>
            <p className="mb-6">
              Finanslarınızı bizimle kontrol altına alın ve akıllı para yönetiminin getirdiği güveni deneyimleyin.
              İster bütçenizi daha iyi yönetmek isteyin, ister süreçlerinizi optimize etmek.
            </p>
          </RevealAnimation>
