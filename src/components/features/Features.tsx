...
const data = [
  {
    id: 1,
    title: '20.000+ Müşteri Tarafından Güveniliyor',
    description: 'Binlerce işletme TalepNET ile satın alma süreçlerini dijitalleştiriyor.',
    img: featureAsset1,
  },
  {
    id: 2,
    title: 'Özelleştirilebilir faturalama çözümleri',
    description: 'İhtiyaçlarınıza uygun esnek faturalama ve ödeme yönetimi.',
    img: featureAsset2,
  },
  {
    id: 3,
    title: 'Envanter takibi',
    description: 'Stok seviyelerini gerçek zamanlı izleyin ve yönetin.',
    img: featureAsset3,
  },
  {
    id: 4,
    title: 'Mobil uygulama',
    description: 'Her yerden erişim sağlayın ve süreçlerinizi mobil cihazlardan yönetin.',
    img: featureAsset4,
  },
  {
    id: 5,
    title: 'Yapılandırılmış giderler',
    description: 'Giderlerinizi kategorize edin, analiz edin ve kontrol altında tutun.',
    img: featureAsset5,
  },
  {
    id: 6,
    title: 'Analiz ve raporlar',
    description: 'Detaylı raporlar ve görselleştirmelerle veri odaklı kararlar alın.',
    img: featureAsset6,
  },
];
      ...
      <div className="main-container">
        <div className="mb-14 space-y-3 text-center">
          <RevealAnimation delay={0.3}>
            <h2 className="mx-auto max-w-[742px]">Başarı için ihtiyacınız olan her şey. Tek bir platformda.</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.4}>
            <p className="mx-auto max-w-[482px]">
              TalepNET, işletmenizi büyütmenize, optimize etmenize ve ölçeklendirmenize yardımcı olacak güçlü ve
              kullanımı kolay araçlar sunar.
            </p>
          </RevealAnimation>
        </div>
