      ...
      <div className="main-container space-y-14 md:space-y-[70px]">
        <div className="space-y-3 text-center">
          <RevealAnimation delay={0.2}>
            <span className="badge badge-cyan mb-5">Organizasyonlar İçin Akıllı Satın Alma</span>
          </RevealAnimation>
          <RevealAnimation delay={0.3}>
            <h2 className="xl:text-heading-1 mx-auto font-medium lg:max-w-[980px]">
              Satın alma süreçlerinizi akıllı otomasyon ile dönüştürün.
            </h2>
          </RevealAnimation>
          <RevealAnimation delay={0.4}>
            <p className="mx-auto lg:max-w-[904px]">
              TalepNET, kurumsal satın alma süreçlerinizi iş akışı sihirbazı ile kolayca oluşturmanızı,
              tedarikçi ağınızı genişletmenizi ve online teklif toplama ile sipariş yönetimini dijitalleştirmenizi sağlar.
              Basit, hızlı, güvenli ve etkili.
            </p>
          </RevealAnimation>
        </div>
          ...
          <article className="space-y-[37px] max-md:w-full">
            ...
            <RevealAnimation delay={0.4} direction="right">
              <div className="bg-secondary dark:bg-accent flex h-auto w-full flex-col items-start gap-1 rounded-2xl p-4 md:h-[91px] md:w-[148px]">
                <h3 className="text-tagline-2 text-accent dark:text-secondary font-normal">Süreç verimliliği</h3>
            ...
            <RevealAnimation delay={0.6} direction="right">
              <div className="max-w-full min-w-full rounded-2xl bg-white p-6 md:max-w-[288px] md:min-w-[288px] dark:bg-black">
                <div className="text-left">
                  <span className="text-tagline-2 text-secondary dark:text-accent font-normal">Satın Alma Bütçesi</span>
