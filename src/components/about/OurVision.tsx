      ...
      <div className="main-container space-y-16 md:space-y-[100px]">
        <div className="space-y-3 text-center">
          <RevealAnimation delay={0.2}>
            <span className="badge badge-cyan mb-5">Vizyonumuz</span>
          </RevealAnimation>
          <RevealAnimation delay={0.3}>
            <h2>Tedarik zincirinin geleceğini şekillendirmek</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.4}>
            <p className="mx-auto max-w-[806px]">
              Vizyonumuz, dünya genelinde kurumsal satın alma süreçlerini dijitalleştirerek tedarik zincirinin
              geleceğini şekillendirmektir. Birleşik bir tedarik sistemi ile satın alma, teklif yönetimi,
              tedarikçi değerlendirmesi ve bütçe kontrolünü tek platformda sunarak organizasyonların daha
              hızlı, şeffaf ve verimli çalışmasını hedefliyoruz.
            </p>
          </RevealAnimation>
        </div>
        {/*  */}
