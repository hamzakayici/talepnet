          ...
          <div className="col-span-12 mx-4 lg:col-span-6 xl:mx-0">
            <div className="space-y-3">
              <RevealAnimation delay={0.1}>
                <span className="badge badge-cyan mb-5">Misyonumuz</span>
              </RevealAnimation>
              <RevealAnimation delay={0.2}>
                <h2>Kurumsal satın alma süreçlerini dijitalleştirerek şirketlerin daha verimli çalışmasını sağlamak</h2>
              </RevealAnimation>
              <RevealAnimation delay={0.4}>
                <p>
                  TalepNET olarak misyonumuz, her ölçekteki organizasyonun satın alma süreçlerini akıllı otomasyon
                  ve izlenebilirlik ile dönüştürmektir. İş akışı sihirbazımız ile süreçlerinizi kolayca tasarlayın,
                  tedarikçi ağınızı genişletin, online teklif toplayın ve satın alma siparişlerinizi dijital yönetin.
                </p>
              </RevealAnimation>
            </div>
          </div>
            ...
            <RevealAnimation delay={0.6}>
              <div className="dark:bg-background-8 shadow-2 relative z-10 flex h-full min-h-[380px] items-center justify-center overflow-hidden rounded-[20px] bg-white/60 p-[26px] backdrop-blur-[20px]">
                ...
                <div className="-mt-20 text-center">
                  ...
                  <p className="text-secondary/60 dark:text-accent/60">Dünya genelinde kurumsal müşteriler</p>
                </div>
              </div>
            </RevealAnimation>
          </div>
