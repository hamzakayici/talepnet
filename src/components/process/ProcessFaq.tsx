        ...
        <div className="mx-auto mb-[70px] max-w-[620px] space-y-5 text-center">
          ...
          <div className="space-y-3">
            ...
            <RevealAnimation delay={0.3}>
              <p>
                Kısa ve bilgilendirici yanıtlar sunarak, bu bölüm kullanıcıların müşteri desteğiyle iletişime geçmeden
                çözümler bulmalarına yardımcı olarak zaman kazanılmasını sağlar.
              </p>
            </RevealAnimation>
          </div>
        </div>
