        ...
        <div className="max-w-[950px] mx-auto w-full">
          <RevealAnimation delay={0.1}>
            <div className="py-8 space-y-3">
              ...
              <p>
                ...
                TalepNET is registered in the Trade and Companies Register under number 000000000. <br />
          ...
          <RevealAnimation delay={0.4}>
            <div className="py-8 space-y-3">
              ...
              <p>
                This website has been designed and developed by TalepNET Design Studio. <br />
                Website:{' '}
                <Link href="/" className="text-primary-500">
