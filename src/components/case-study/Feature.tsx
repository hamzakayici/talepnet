...
const featureList = [
  {
    id: 1,
    text: 'Yönetim ekipleri için merkezi satın alma analitiği',
  },
  {
    id: 2,
    text: 'Satın alma, tedarik ve operasyon genelinde iş akışı otomasyonu',
  },
  {
    id: 3,
    text: 'Tedarikçi onboarding ve ilişki yönetiminde iyileştirme',
  },
  {
    id: 4,
    text: 'Harcama takibi ve maliyet optimizasyonu raporlama',
  },
  {
    id: 5,
    text: 'Güvenli ve uyumlu veri erişimi',
  },
];
            ...
            <div className="grid grid-cols-2 gap-5 px-6 py-14 max-sm:grid-cols-1 max-sm:gap-10 md:px-11">
              <div className="max-w-[500px]">
                <h2 className="text-accent text-heading-5 mb-8">
                  Başarıyla çözdüğümüz kullanım alanlarından bazıları: iş akışı verimliliğini optimize etme,
                  tedarikçi yönetimini güçlendirme
                </h2>
                <div>
                  <Link
                    href="/purchase-forms"
