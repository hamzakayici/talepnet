          ...
          <div className="overflow-hidden rounded-[34px] bg-[linear-gradient(135deg,#0f172a_0%,#153b4a_55%,#0b1020_100%)] p-8 text-white md:p-12 xl:p-14">
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
              <div className="max-w-3xl">
                <p className="text-3xl font-normal leading-tight text-white lg:text-5xl">Still have questions?</p>
                <p className="mt-5 max-w-2xl text-base leading-7 text-white/70">
                  If your question is not covered here, reach out to our team and we will help you find the right answer.
                </p>
              </div>
