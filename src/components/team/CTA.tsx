        ...
        <div className="">
          <div className="space-y-3 text-center">
            <RevealAnimation delay={0.1}>
              <span className="badge badge-cyan mb-5 inline-block">Ücretsiz Başlayın</span>
            </RevealAnimation>
            <RevealAnimation delay={0.2}>
              <h2 className="mx-auto max-w-[1042px]">
                TalepNET – satın alma süreçlerinizi dijitalleştiren &amp; hızlandıran platform
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[600px]">
                Daha fazla etkileşim sağlayın. Verimliliği artırın. Süreçlerinizi otomatikleştirin.
              </p>
            </RevealAnimation>
          </div>
            ...
            <ul className="flex items-center justify-center gap-[42px]">
              <RevealAnimation delay={0.2}>
                <li className="flex items-center justify-center gap-2">
                  ...
                  <p className="text-tagline-2">Kredi kartı gerekmez</p>
                </li>
              </RevealAnimation>
              <RevealAnimation delay={0.3}>
                <li className="flex items-center justify-center gap-2">
                  ...
                  <p className="text-tagline-2">14 gün ücretsiz deneme</p>
                </li>
              </RevealAnimation>
            </ul>
          </div>
