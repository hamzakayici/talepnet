      ...
      <div className="main-container space-y-[70px]">
        <div className="space-y-5 text-center">
          <RevealAnimation delay={0.1}>
            <span className="badge badge-cyan">Ekibimiz</span>
          </RevealAnimation>
          <div className="mx-auto max-w-[620px] space-y-3">
            <RevealAnimation delay={0.2}>
              <h2>Yenilikçi, dinamik ve yetenekli ekibimiz</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p>
                Yenilikçi, dinamik ve yetenekli ekibimiz başarımızın arkasındaki itici güçtür. Her üye,
                benzersiz bir uzmanlık ve deneyim bileşimi sunar.
              </p>
            </RevealAnimation>
          </div>
        </div>
