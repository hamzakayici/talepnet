        ...
        <div className="mb-[70px] space-y-5 text-center">
          <div className="space-y-3">
            <RevealAnimation delay={0.1}>
              <h2>Bu alanda on yılı aşkın deneyim.</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.2}>
              <p className="mx-auto max-w-[744px]">
                On yılı aşkın uygulamalı deneyimimizle sektörümüzde güçlü bir bilgi, beceri ve güven
                temeli oluşturduk. Yıllar boyunca gelişen trendlere uyum sağladık, yeni teknolojileri benimsedik.
              </p>
            </RevealAnimation>
          </div>
        </div>
