          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="space-y-3">
              <RevealAnimation delay={0.1}>
                <span className="badge badge-green">Kullanım Alanları</span>
              </RevealAnimation>
              <RevealAnimation delay={0.2}>
                <h2 className="max-w-[518px]">Müşterilerimizle Nasıl Bağlantı Kuruyoruz</h2>
              </RevealAnimation>
            </div>
          </div>
          <div className="flex-1 text-center lg:text-left">
            <div>
              <RevealAnimation delay={0.3}>
                <p className="mx-auto max-w-[518px] lg:mx-0">
                  Yenilikçi çözümlerimizin kuruluşunuzda iletişimi nasıl iyileştirdiğini ve verimliliği nasıl
                  artırdığını keşfedin. Düzenli iş akışlarından geliştirilmiş işbirliği araçlarına kadar,
                  başarı için ihtiyacınız olan her şeyi sunuyoruz.
                </p>
              </RevealAnimation>
            </div>
          </div>
