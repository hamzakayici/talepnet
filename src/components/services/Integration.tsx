          ...
          <div className="pt-5 max-lg:order-1">
            <div className="mx-auto max-w-[592px] text-center lg:mx-0 lg:max-w-full lg:text-left">
              <div className="mb-8 space-y-5">
                <RevealAnimation delay={0.2}>
                  <span className="badge badge-green mb-5">Veri Entegrasyonları</span>
                </RevealAnimation>
                <div className="mb-8 space-y-3">
                  <RevealAnimation delay={0.3}>
                    <h2 className="mx-auto max-w-[592px] lg:mx-0">
                      Satın alma dinamiklerini anlamak için net bir vizyon şart.
                    </h2>
                  </RevealAnimation>
                  <RevealAnimation delay={0.4}>
                    <p>
                      Net bir vizyon, satın alma dinamiklerini anlamak için gereklidir çünkü ölçeklenebilir
                      büyüme ve sürdürülebilirlik için yön, amaç ve netlik sağlar.
                    </p>
                  </RevealAnimation>
                </div>
              </div>
